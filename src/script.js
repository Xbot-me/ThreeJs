...
// Objects
const geometry = new THREE.BoxGeometry( 0.5, .5, .5,10,10,10);
...
material.color = new THREE.Color(0x0000)
...
gui.add(pointLight2.position, 'x').min(-10).max(6).step(0.01);
...
const tick = () =>
{
    ...
    if(sphere.position.z == 1.006){
        sphere.position.z = 0.001
    }
    console.log(sphere.position.z)
   
    //sphere.position.z = i * elapsedTime
   // sphere.position.z =  * elapsedTime
